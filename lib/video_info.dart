                        ...
                        Container(width: 230,
                          ...
                          child: Row(
                            children: [
                              ...
                              Text("Resistent band,kettebell",style: appStyle(15,FontWeight.bold, Colors.white),)
...
if(controller!=null&&controller.value.isInitialized){
  ...
  Text("Initalize plz wait");

}
  }
  _onTapVideo(int index){
  final controller=VideoPlayerController.networkUrl(video_Info[index]["videoUrl"]);
